...
# Bot information
SESSION = environ.get('SESSION', 'Media_searc_Bot')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', 'mongodb+srv://Popcorn:Priyanshu@cluster0.zotkw95.mongodb.net/?retryWrites=true&w=majority')
